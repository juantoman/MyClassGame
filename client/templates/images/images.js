...
Template.imagesTemplate.onRendered(function() {
   ...
   //cloudName: 'myclassgame', 'c4mcg1', 'c4mcg2', 'c4mcg3', 'c4mcg4'
   ...
   widget = cloudinary.createUploadWidget({ cloudName: 'c4mcg4', uploadPreset: 'myclassgame', googleApiKey: key, searchBySites: ["all", "cloudinary.com"], searchByRights: true}, function(error, result){
