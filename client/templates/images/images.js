...
Template.imagesTemplate.onRendered(function() {
   ...
   widget = cloudinary.createUploadWidget({ cloudName: cloudNames[r], uploadPreset: 'myclassgame', googleApiKey: key, searchBySites: ["all", "cloudinary.com"], searchByRights: true}, function(error, result){
