...
Meteor.methods({
  ...
  studentModify: function(studentId,studentName,alias,avatar,email) {
    var studentId = students.update({ _id: studentId }, { $set: {studentName: studentName, alias: alias, avatar: avatar, email: email} });
  },
