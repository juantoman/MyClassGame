...
Meteor.methods({
  ...
  noRandomGroup: function(rId) {
    var Id = groups.update({ '_id': rId }, { $set: {'random': false } });
  },
  allRandomGroups: function(classId) {
    var Id = groups.update({'classId': classId}, { $set: {'random': true } }, { multi: true});
  }
});
