...
Router.route('/students/:_id', {name: 'studentsMainPage',
  waitOn: function() {
    return [
      Meteor.subscribe('allUsers'),
...
Router.route('/dessign/:_id', {name: 'dessignTemplate',
  waitOn: function() {
    return [
      //Meteor.subscribe('allUsers'),
      Meteor.subscribe('images',this.params._id),
  ...
  layoutTemplate: 'gamification'
});

Router.route('/components/:_id', {name: 'componentsTemplate',
  waitOn: function() {
    return [
      //Meteor.subscribe('allUsers'),
      Meteor.subscribe('images',this.params._id),
...
Router.route('/adventure/:_id', {name: 'adventure',
  waitOn: function() {
    return [
      //Meteor.subscribe('allUsers'),
      Meteor.subscribe('images',this.params._id),
...
Router.route('/missions/:_id', {name: 'missions',
  waitOn: function() {
    return [
      //Meteor.subscribe('allUsers'),
      Meteor.subscribe('classes',this.params._id),
