...
Router.route('/class/:_id', {name: 'myNav',
  waitOn: function() {
    return [
      Meteor.subscribe('allUsers'),
...
Router.route('/student/:_id', {name: 'studentPage',
  waitOn: function() {
    return [
      ...
      Meteor.subscribe('randomEvents',"student",this.params._id),
      ...
      Meteor.subscribe('convictions',"student",this.params._id),
      Meteor.subscribe('quotes',"student",this.params._id),
      ...
      Meteor.subscribe('chatClass',"student",this.params._id),
      Meteor.subscribe('chatTeachers'),
